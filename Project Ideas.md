- المشروع الذي تعمل عليه يتطلب منك إنشاء لوحة تحكم (Dashboard) خاصة بمتجر Google Merchandise Store باستخدام **Looker Studio** استناداً إلى بيانات Google Analytics 4 (GA4). 
